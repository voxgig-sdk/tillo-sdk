...
func registerTools(server *mcp.Server, client *sdk.TilloSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "tillo_list",
		Description: "List records from Tillo. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "tillo_load",
		Description: "Load a single record from Tillo. " +
...
func runOp(client *sdk.TilloSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.TilloSDK, name string) (sdk.TilloEntity, error) {
