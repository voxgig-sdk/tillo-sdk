# Tillo SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions TilloSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both TilloSDK(...) and TilloSDK.test(...) become
#      TilloSDK.test({"entity": {...}}) seeding one mock record (id "test01")
