...
class PhysicalOrderStatusEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return PhysicalOrderStatusEntity(self._client, opts)
    ...
    def data_get(self) -> PhysicalOrderStatus:
    ...
    def match_get(self) -> PhysicalOrderStatus:
    ...
    def create(self, reqdata: PhysicalOrderStatusCreateData, ctrl=None) -> PhysicalOrderStatus:
        utility = self._utility
