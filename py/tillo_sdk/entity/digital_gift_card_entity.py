...
class DigitalGiftCardEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return DigitalGiftCardEntity(self._client, opts)
    ...
    def data_get(self) -> DigitalGiftCard:
    ...
    def match_get(self) -> DigitalGiftCard:
    ...
    def load(self, reqmatch=None, ctrl=None) -> DigitalGiftCard:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.DigitalGiftCard().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def create(self, reqdata: DigitalGiftCardCreateData, ctrl=None) -> DigitalGiftCard:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
