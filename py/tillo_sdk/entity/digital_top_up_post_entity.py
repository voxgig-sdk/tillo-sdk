...
class DigitalTopUpPostEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return DigitalTopUpPostEntity(self._client, opts)
    ...
    def data_get(self) -> DigitalTopUpPost:
    ...
    def match_get(self) -> DigitalTopUpPost:
    ...
    def create(self, reqdata: DigitalTopUpPostCreateData, ctrl=None) -> DigitalTopUpPost:
        utility = self._utility
