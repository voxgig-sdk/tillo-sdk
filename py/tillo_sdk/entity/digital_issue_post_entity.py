...
class DigitalIssuePostEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return DigitalIssuePostEntity(self._client, opts)
    ...
    def data_get(self) -> DigitalIssuePost:
    ...
    def match_get(self) -> DigitalIssuePost:
    ...
    def create(self, reqdata: DigitalIssuePostCreateData, ctrl=None) -> DigitalIssuePost:
        utility = self._utility
