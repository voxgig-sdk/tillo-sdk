...
class PhysicalOrderCardEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return PhysicalOrderCardEntity(self._client, opts)
    ...
    def data_get(self) -> PhysicalOrderCard:
    ...
    def match_get(self) -> PhysicalOrderCard:
    ...
    def create(self, reqdata: PhysicalOrderCardCreateData, ctrl=None) -> PhysicalOrderCard:
        utility = self._utility
