...
class DigitalOrderCardEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return DigitalOrderCardEntity(self._client, opts)
    ...
    def data_get(self) -> DigitalOrderCard:
    ...
    def match_get(self) -> DigitalOrderCard:
    ...
    def create(self, reqdata: DigitalOrderCardCreateData, ctrl=None) -> DigitalOrderCard:
        utility = self._utility
