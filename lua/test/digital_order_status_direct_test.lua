...
describe("DigitalOrderStatusDirect", function()
  it("should direct-load-digital_order_status", function()
    local setup = digital_order_status_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-digital_order_status", setup.live and "live" or "unit")
