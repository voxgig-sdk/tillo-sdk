...
describe("BrandDirect", function()
  it("should direct-list-brand", function()
    local setup = brand_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-brand", setup.live and "live" or "unit")
