...
describe("BrandDirect", function()
  it("should direct-load-brand", function()
    local setup = brand_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-brand", setup.live and "live" or "unit")
