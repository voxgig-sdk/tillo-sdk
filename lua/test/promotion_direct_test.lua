...
describe("PromotionDirect", function()
  it("should direct-load-promotion", function()
    local setup = promotion_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-promotion", setup.live and "live" or "unit")
