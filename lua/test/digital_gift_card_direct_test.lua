...
describe("DigitalGiftCardDirect", function()
  it("should direct-load-digital_gift_card", function()
    local setup = digital_gift_card_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-digital_gift_card", setup.live and "live" or "unit")
