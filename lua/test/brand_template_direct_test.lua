...
describe("BrandTemplateDirect", function()
  it("should direct-load-brand_template", function()
    local setup = brand_template_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-brand_template", setup.live and "live" or "unit")
