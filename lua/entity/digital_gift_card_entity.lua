...
local DigitalGiftCardEntity = {}
DigitalGiftCardEntity.__index = DigitalGiftCardEntity


function DigitalGiftCardEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, DigitalGiftCardEntity)
  self._name = "digital_gift_card"
  self._client = client
...
function DigitalGiftCardEntity:get_name()
  return self._name
end


function DigitalGiftCardEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return DigitalGiftCardEntity.new(self._client, opts)
end
...
function DigitalGiftCardEntity:mark_deleted()
  self._deleted = true
end


function DigitalGiftCardEntity:deleted()
  return true == self._deleted
end


function DigitalGiftCardEntity:data_set(args)
  if args ~= nil then
...
function DigitalGiftCardEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function DigitalGiftCardEntity:match_set(args)
  if args ~= nil then
...
function DigitalGiftCardEntity:match_get()
...
function DigitalGiftCardEntity:stream(action, args, callopts)
...
---@param reqmatch DigitalGiftCardLoadMatch
---@param ctrl? table
---@return DigitalGiftCard
---@return string? err
function DigitalGiftCardEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata DigitalGiftCardCreateData
---@param ctrl? table
---@return DigitalGiftCard
---@return string? err
function DigitalGiftCardEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
function DigitalGiftCardEntity:_run_op(ctx, post_done)
  local utility = self._utility
