-- Tillo SDK BrandTemplate entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local BrandTemplateEntity = {}
BrandTemplateEntity.__index = BrandTemplateEntity


function BrandTemplateEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, BrandTemplateEntity)
  self._name = "brand_template"
  self._client = client
...
function BrandTemplateEntity:get_name()
  return self._name
end


function BrandTemplateEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return BrandTemplateEntity.new(self._client, opts)
end
...
function BrandTemplateEntity:mark_deleted()
  self._deleted = true
end


function BrandTemplateEntity:deleted()
  return true == self._deleted
end


function BrandTemplateEntity:data_set(args)
  if args ~= nil then
...
function BrandTemplateEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function BrandTemplateEntity:match_set(args)
  if args ~= nil then
...
function BrandTemplateEntity:match_get()
...
function BrandTemplateEntity:stream(action, args, callopts)
...
---@param reqmatch BrandTemplateLoadMatch
---@param ctrl? table
---@return BrandTemplate
---@return string? err
function BrandTemplateEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function BrandTemplateEntity:_run_op(ctx, post_done)
  local utility = self._utility
