-- Tillo SDK DigitalTopUpPost entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local DigitalTopUpPostEntity = {}
DigitalTopUpPostEntity.__index = DigitalTopUpPostEntity


function DigitalTopUpPostEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, DigitalTopUpPostEntity)
  self._name = "digital_top_up_post"
  self._client = client
...
function DigitalTopUpPostEntity:get_name()
  return self._name
end


function DigitalTopUpPostEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return DigitalTopUpPostEntity.new(self._client, opts)
end
...
function DigitalTopUpPostEntity:mark_deleted()
  self._deleted = true
end


function DigitalTopUpPostEntity:deleted()
  return true == self._deleted
end


function DigitalTopUpPostEntity:data_set(args)
  if args ~= nil then
...
function DigitalTopUpPostEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function DigitalTopUpPostEntity:match_set(args)
  if args ~= nil then
...
function DigitalTopUpPostEntity:match_get()
...
function DigitalTopUpPostEntity:stream(action, args, callopts)
...
---@param reqdata DigitalTopUpPostCreateData
---@param ctrl? table
---@return DigitalTopUpPost
---@return string? err
function DigitalTopUpPostEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function DigitalTopUpPostEntity:_run_op(ctx, post_done)
  local utility = self._utility
