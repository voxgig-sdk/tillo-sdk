-- Tillo SDK PhysicalOrderCard entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local PhysicalOrderCardEntity = {}
PhysicalOrderCardEntity.__index = PhysicalOrderCardEntity


function PhysicalOrderCardEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, PhysicalOrderCardEntity)
  self._name = "physical_order_card"
  self._client = client
...
function PhysicalOrderCardEntity:get_name()
  return self._name
end


function PhysicalOrderCardEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return PhysicalOrderCardEntity.new(self._client, opts)
end
...
function PhysicalOrderCardEntity:mark_deleted()
  self._deleted = true
end


function PhysicalOrderCardEntity:deleted()
  return true == self._deleted
end


function PhysicalOrderCardEntity:data_set(args)
  if args ~= nil then
...
function PhysicalOrderCardEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function PhysicalOrderCardEntity:match_set(args)
  if args ~= nil then
...
function PhysicalOrderCardEntity:match_get()
...
function PhysicalOrderCardEntity:stream(action, args, callopts)
...
---@param reqdata PhysicalOrderCardCreateData
---@param ctrl? table
---@return PhysicalOrderCard
---@return string? err
function PhysicalOrderCardEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function PhysicalOrderCardEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return PhysicalOrderCardEntity
