...
local PhysicalGiftCardEntity = {}
PhysicalGiftCardEntity.__index = PhysicalGiftCardEntity


function PhysicalGiftCardEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, PhysicalGiftCardEntity)
  self._name = "physical_gift_card"
  self._client = client
...
function PhysicalGiftCardEntity:get_name()
  return self._name
end


function PhysicalGiftCardEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return PhysicalGiftCardEntity.new(self._client, opts)
end
...
function PhysicalGiftCardEntity:mark_deleted()
  self._deleted = true
end


function PhysicalGiftCardEntity:deleted()
  return true == self._deleted
end


function PhysicalGiftCardEntity:data_set(args)
  if args ~= nil then
...
function PhysicalGiftCardEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function PhysicalGiftCardEntity:match_set(args)
  if args ~= nil then
...
function PhysicalGiftCardEntity:match_get()
...
function PhysicalGiftCardEntity:stream(action, args, callopts)
...
---@param reqdata PhysicalGiftCardCreateData
---@param ctrl? table
---@return PhysicalGiftCard
---@return string? err
function PhysicalGiftCardEntity:create(reqdata, ctrl)
  local utility = self._utility
...
---@param reqmatch PhysicalGiftCardRemoveMatch
---@param ctrl? table
---@return PhysicalGiftCard
---@return string? err
function PhysicalGiftCardEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function PhysicalGiftCardEntity:_run_op(ctx, post_done)
  local utility = self._utility
