-- Tillo SDK DigitalIssuePost entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local DigitalIssuePostEntity = {}
DigitalIssuePostEntity.__index = DigitalIssuePostEntity


function DigitalIssuePostEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, DigitalIssuePostEntity)
  self._name = "digital_issue_post"
  self._client = client
...
function DigitalIssuePostEntity:get_name()
  return self._name
end


function DigitalIssuePostEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return DigitalIssuePostEntity.new(self._client, opts)
end
...
function DigitalIssuePostEntity:mark_deleted()
  self._deleted = true
end


function DigitalIssuePostEntity:deleted()
  return true == self._deleted
end


function DigitalIssuePostEntity:data_set(args)
  if args ~= nil then
...
function DigitalIssuePostEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function DigitalIssuePostEntity:match_set(args)
  if args ~= nil then
...
function DigitalIssuePostEntity:match_get()
...
function DigitalIssuePostEntity:stream(action, args, callopts)
...
---@param reqdata DigitalIssuePostCreateData
---@param ctrl? table
---@return DigitalIssuePost
---@return string? err
function DigitalIssuePostEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function DigitalIssuePostEntity:_run_op(ctx, post_done)
  local utility = self._utility
