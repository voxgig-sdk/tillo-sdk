...
local DigitalIssueDeleteEntity = {}
DigitalIssueDeleteEntity.__index = DigitalIssueDeleteEntity


function DigitalIssueDeleteEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, DigitalIssueDeleteEntity)
  self._name = "digital_issue_delete"
  self._client = client
...
function DigitalIssueDeleteEntity:get_name()
  return self._name
end


function DigitalIssueDeleteEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return DigitalIssueDeleteEntity.new(self._client, opts)
end
...
function DigitalIssueDeleteEntity:mark_deleted()
  self._deleted = true
end


function DigitalIssueDeleteEntity:deleted()
  return true == self._deleted
end


function DigitalIssueDeleteEntity:data_set(args)
  if args ~= nil then
...
function DigitalIssueDeleteEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function DigitalIssueDeleteEntity:match_set(args)
  if args ~= nil then
...
function DigitalIssueDeleteEntity:match_get()
...
function DigitalIssueDeleteEntity:stream(action, args, callopts)
...
---@param reqdata DigitalIssueDeleteCreateData
---@param ctrl? table
---@return DigitalIssueDelete
---@return string? err
function DigitalIssueDeleteEntity:create(reqdata, ctrl)
  local utility = self._utility
...
---@param reqmatch DigitalIssueDeleteRemoveMatch
---@param ctrl? table
---@return DigitalIssueDelete
---@return string? err
function DigitalIssueDeleteEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function DigitalIssueDeleteEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return DigitalIssueDeleteEntity
