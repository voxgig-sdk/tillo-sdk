...
type PhysicalOrderCardEntity struct {
	name    string
...
func NewPhysicalOrderCardEntity(client *core.TilloSDK, entopts map[string]any) *PhysicalOrderCardEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PhysicalOrderCardEntity) GetName() string { return e.name }
...
func (e *PhysicalOrderCardEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PhysicalOrderCardEntity) Deleted() bool {
	return e.deleted
}


func (e *PhysicalOrderCardEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPhysicalOrderCardEntity(e.client, opts)
}

func (e *PhysicalOrderCardEntity) Data(args ...any) any {
...
func (e *PhysicalOrderCardEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an PhysicalOrderCard; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PhysicalOrderCardEntity) DataTyped(data ...PhysicalOrderCard) PhysicalOrderCard {
	if len(data) > 0 {
		return typedFrom[PhysicalOrderCard](e.Data(asMap(data[0])))
	}
	return typedFrom[PhysicalOrderCard](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through PhysicalOrderCard (all fields
// optional at the wire level).
func (e *PhysicalOrderCardEntity) MatchTyped(match ...PhysicalOrderCard) PhysicalOrderCard {
	if len(match) > 0 {
		return typedFrom[PhysicalOrderCard](e.Match(asMap(match[0])))
	}
	return typedFrom[PhysicalOrderCard](e.Match())
}
...
func (e *PhysicalOrderCardEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PhysicalOrderCardEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *PhysicalOrderCardEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *PhysicalOrderCardEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PhysicalOrderCardCreateData and returns an PhysicalOrderCard. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *PhysicalOrderCardEntity) CreateTyped(reqdata PhysicalOrderCardCreateData, ctrl map[string]any) (PhysicalOrderCard, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return PhysicalOrderCard{}, err
	}
	return typedFrom[PhysicalOrderCard](res), nil
}



func (e *PhysicalOrderCardEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *PhysicalOrderCardEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PhysicalOrderCardEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
