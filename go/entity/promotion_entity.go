...
func NewPromotionEntity(client *core.TilloSDK, entopts map[string]any) *PromotionEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PromotionEntity) GetName() string { return e.name }
...
func (e *PromotionEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PromotionEntity) Deleted() bool {
	return e.deleted
}


func (e *PromotionEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPromotionEntity(e.client, opts)
}

func (e *PromotionEntity) Data(args ...any) any {
...
func (e *PromotionEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Promotion; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PromotionEntity) DataTyped(data ...Promotion) Promotion {
	if len(data) > 0 {
		return typedFrom[Promotion](e.Data(asMap(data[0])))
	}
	return typedFrom[Promotion](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Promotion (all fields
// optional at the wire level).
func (e *PromotionEntity) MatchTyped(match ...Promotion) Promotion {
	if len(match) > 0 {
		return typedFrom[Promotion](e.Match(asMap(match[0])))
	}
	return typedFrom[Promotion](e.Match())
}
...
func (e *PromotionEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PromotionEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PromotionLoadMatch and returns an Promotion. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *PromotionEntity) LoadTyped(reqmatch PromotionLoadMatch, ctrl map[string]any) (Promotion, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Promotion{}, err
	}
	return typedFrom[Promotion](res), nil
}



func (e *PromotionEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *PromotionEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *PromotionEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *PromotionEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PromotionEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
