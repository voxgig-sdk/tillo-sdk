...
func NewDgcEntity(client *core.TilloSDK, entopts map[string]any) *DgcEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DgcEntity) GetName() string { return e.name }
...
func (e *DgcEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DgcEntity) Deleted() bool {
	return e.deleted
}


func (e *DgcEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDgcEntity(e.client, opts)
}

func (e *DgcEntity) Data(args ...any) any {
...
func (e *DgcEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Dgc; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *DgcEntity) DataTyped(data ...Dgc) Dgc {
	if len(data) > 0 {
		return typedFrom[Dgc](e.Data(asMap(data[0])))
	}
	return typedFrom[Dgc](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Dgc (all fields
// optional at the wire level).
func (e *DgcEntity) MatchTyped(match ...Dgc) Dgc {
	if len(match) > 0 {
		return typedFrom[Dgc](e.Match(asMap(match[0])))
	}
	return typedFrom[Dgc](e.Match())
}
...
func (e *DgcEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DgcEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *DgcEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *DgcEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// DgcCreateData and returns an Dgc. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *DgcEntity) CreateTyped(reqdata DgcCreateData, ctrl map[string]any) (Dgc, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return Dgc{}, err
	}
	return typedFrom[Dgc](res), nil
}



func (e *DgcEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *DgcEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *DgcEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
