...
type DigitalIssuePostEntity struct {
	name    string
...
func NewDigitalIssuePostEntity(client *core.TilloSDK, entopts map[string]any) *DigitalIssuePostEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DigitalIssuePostEntity) GetName() string { return e.name }
...
func (e *DigitalIssuePostEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DigitalIssuePostEntity) Deleted() bool {
	return e.deleted
}


func (e *DigitalIssuePostEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDigitalIssuePostEntity(e.client, opts)
}

func (e *DigitalIssuePostEntity) Data(args ...any) any {
...
func (e *DigitalIssuePostEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an DigitalIssuePost; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *DigitalIssuePostEntity) DataTyped(data ...DigitalIssuePost) DigitalIssuePost {
	if len(data) > 0 {
		return typedFrom[DigitalIssuePost](e.Data(asMap(data[0])))
	}
	return typedFrom[DigitalIssuePost](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through DigitalIssuePost (all fields
// optional at the wire level).
func (e *DigitalIssuePostEntity) MatchTyped(match ...DigitalIssuePost) DigitalIssuePost {
	if len(match) > 0 {
		return typedFrom[DigitalIssuePost](e.Match(asMap(match[0])))
	}
	return typedFrom[DigitalIssuePost](e.Match())
}
...
func (e *DigitalIssuePostEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DigitalIssuePostEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *DigitalIssuePostEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *DigitalIssuePostEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// DigitalIssuePostCreateData and returns an DigitalIssuePost. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *DigitalIssuePostEntity) CreateTyped(reqdata DigitalIssuePostCreateData, ctrl map[string]any) (DigitalIssuePost, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return DigitalIssuePost{}, err
	}
	return typedFrom[DigitalIssuePost](res), nil
}



func (e *DigitalIssuePostEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *DigitalIssuePostEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *DigitalIssuePostEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
