...
type DigitalOrderCardEntity struct {
	name    string
...
func NewDigitalOrderCardEntity(client *core.TilloSDK, entopts map[string]any) *DigitalOrderCardEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DigitalOrderCardEntity) GetName() string { return e.name }
...
func (e *DigitalOrderCardEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DigitalOrderCardEntity) Deleted() bool {
	return e.deleted
}


func (e *DigitalOrderCardEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDigitalOrderCardEntity(e.client, opts)
}

func (e *DigitalOrderCardEntity) Data(args ...any) any {
...
func (e *DigitalOrderCardEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an DigitalOrderCard; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *DigitalOrderCardEntity) DataTyped(data ...DigitalOrderCard) DigitalOrderCard {
	if len(data) > 0 {
		return typedFrom[DigitalOrderCard](e.Data(asMap(data[0])))
	}
	return typedFrom[DigitalOrderCard](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through DigitalOrderCard (all fields
// optional at the wire level).
func (e *DigitalOrderCardEntity) MatchTyped(match ...DigitalOrderCard) DigitalOrderCard {
	if len(match) > 0 {
		return typedFrom[DigitalOrderCard](e.Match(asMap(match[0])))
	}
	return typedFrom[DigitalOrderCard](e.Match())
}
...
func (e *DigitalOrderCardEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DigitalOrderCardEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *DigitalOrderCardEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *DigitalOrderCardEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// DigitalOrderCardCreateData and returns an DigitalOrderCard. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *DigitalOrderCardEntity) CreateTyped(reqdata DigitalOrderCardCreateData, ctrl map[string]any) (DigitalOrderCard, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return DigitalOrderCard{}, err
	}
	return typedFrom[DigitalOrderCard](res), nil
}



func (e *DigitalOrderCardEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *DigitalOrderCardEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *DigitalOrderCardEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
