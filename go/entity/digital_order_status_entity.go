...
type DigitalOrderStatusEntity struct {
	name    string
...
func NewDigitalOrderStatusEntity(client *core.TilloSDK, entopts map[string]any) *DigitalOrderStatusEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DigitalOrderStatusEntity) GetName() string { return e.name }
...
func (e *DigitalOrderStatusEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DigitalOrderStatusEntity) Deleted() bool {
	return e.deleted
}


func (e *DigitalOrderStatusEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDigitalOrderStatusEntity(e.client, opts)
}

func (e *DigitalOrderStatusEntity) Data(args ...any) any {
...
func (e *DigitalOrderStatusEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an DigitalOrderStatus; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *DigitalOrderStatusEntity) DataTyped(data ...DigitalOrderStatus) DigitalOrderStatus {
	if len(data) > 0 {
		return typedFrom[DigitalOrderStatus](e.Data(asMap(data[0])))
	}
	return typedFrom[DigitalOrderStatus](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through DigitalOrderStatus (all fields
// optional at the wire level).
func (e *DigitalOrderStatusEntity) MatchTyped(match ...DigitalOrderStatus) DigitalOrderStatus {
	if len(match) > 0 {
		return typedFrom[DigitalOrderStatus](e.Match(asMap(match[0])))
	}
	return typedFrom[DigitalOrderStatus](e.Match())
}
...
func (e *DigitalOrderStatusEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DigitalOrderStatusEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// DigitalOrderStatusLoadMatch and returns an DigitalOrderStatus. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *DigitalOrderStatusEntity) LoadTyped(reqmatch DigitalOrderStatusLoadMatch, ctrl map[string]any) (DigitalOrderStatus, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return DigitalOrderStatus{}, err
	}
	return typedFrom[DigitalOrderStatus](res), nil
}



func (e *DigitalOrderStatusEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *DigitalOrderStatusEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *DigitalOrderStatusEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *DigitalOrderStatusEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *DigitalOrderStatusEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
