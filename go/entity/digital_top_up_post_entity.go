...
type DigitalTopUpPostEntity struct {
	name    string
...
func NewDigitalTopUpPostEntity(client *core.TilloSDK, entopts map[string]any) *DigitalTopUpPostEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DigitalTopUpPostEntity) GetName() string { return e.name }
...
func (e *DigitalTopUpPostEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DigitalTopUpPostEntity) Deleted() bool {
	return e.deleted
}


func (e *DigitalTopUpPostEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDigitalTopUpPostEntity(e.client, opts)
}

func (e *DigitalTopUpPostEntity) Data(args ...any) any {
...
func (e *DigitalTopUpPostEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an DigitalTopUpPost; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *DigitalTopUpPostEntity) DataTyped(data ...DigitalTopUpPost) DigitalTopUpPost {
	if len(data) > 0 {
		return typedFrom[DigitalTopUpPost](e.Data(asMap(data[0])))
	}
	return typedFrom[DigitalTopUpPost](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through DigitalTopUpPost (all fields
// optional at the wire level).
func (e *DigitalTopUpPostEntity) MatchTyped(match ...DigitalTopUpPost) DigitalTopUpPost {
	if len(match) > 0 {
		return typedFrom[DigitalTopUpPost](e.Match(asMap(match[0])))
	}
	return typedFrom[DigitalTopUpPost](e.Match())
}
...
func (e *DigitalTopUpPostEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DigitalTopUpPostEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *DigitalTopUpPostEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *DigitalTopUpPostEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// DigitalTopUpPostCreateData and returns an DigitalTopUpPost. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *DigitalTopUpPostEntity) CreateTyped(reqdata DigitalTopUpPostCreateData, ctrl map[string]any) (DigitalTopUpPost, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return DigitalTopUpPost{}, err
	}
	return typedFrom[DigitalTopUpPost](res), nil
}



func (e *DigitalTopUpPostEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *DigitalTopUpPostEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *DigitalTopUpPostEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
