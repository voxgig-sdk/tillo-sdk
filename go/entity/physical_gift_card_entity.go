...
type PhysicalGiftCardEntity struct {
	name    string
...
func NewPhysicalGiftCardEntity(client *core.TilloSDK, entopts map[string]any) *PhysicalGiftCardEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PhysicalGiftCardEntity) GetName() string { return e.name }
...
func (e *PhysicalGiftCardEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PhysicalGiftCardEntity) Deleted() bool {
	return e.deleted
}


func (e *PhysicalGiftCardEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPhysicalGiftCardEntity(e.client, opts)
}

func (e *PhysicalGiftCardEntity) Data(args ...any) any {
...
func (e *PhysicalGiftCardEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an PhysicalGiftCard; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PhysicalGiftCardEntity) DataTyped(data ...PhysicalGiftCard) PhysicalGiftCard {
	if len(data) > 0 {
		return typedFrom[PhysicalGiftCard](e.Data(asMap(data[0])))
	}
	return typedFrom[PhysicalGiftCard](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through PhysicalGiftCard (all fields
// optional at the wire level).
func (e *PhysicalGiftCardEntity) MatchTyped(match ...PhysicalGiftCard) PhysicalGiftCard {
	if len(match) > 0 {
		return typedFrom[PhysicalGiftCard](e.Match(asMap(match[0])))
	}
	return typedFrom[PhysicalGiftCard](e.Match())
}
...
func (e *PhysicalGiftCardEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PhysicalGiftCardEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *PhysicalGiftCardEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *PhysicalGiftCardEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PhysicalGiftCardCreateData and returns an PhysicalGiftCard. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *PhysicalGiftCardEntity) CreateTyped(reqdata PhysicalGiftCardCreateData, ctrl map[string]any) (PhysicalGiftCard, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return PhysicalGiftCard{}, err
	}
	return typedFrom[PhysicalGiftCard](res), nil
}



func (e *PhysicalGiftCardEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}



func (e *PhysicalGiftCardEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// PhysicalGiftCardRemoveMatch and returns an PhysicalGiftCard. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *PhysicalGiftCardEntity) RemoveTyped(reqmatch PhysicalGiftCardRemoveMatch, ctrl map[string]any) (PhysicalGiftCard, error) {
...
func (e *PhysicalGiftCardEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
