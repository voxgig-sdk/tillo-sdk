...
type BrandTemplateEntity struct {
	name    string
...
func NewBrandTemplateEntity(client *core.TilloSDK, entopts map[string]any) *BrandTemplateEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *BrandTemplateEntity) GetName() string { return e.name }
...
func (e *BrandTemplateEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *BrandTemplateEntity) Deleted() bool {
	return e.deleted
}


func (e *BrandTemplateEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewBrandTemplateEntity(e.client, opts)
}

func (e *BrandTemplateEntity) Data(args ...any) any {
...
func (e *BrandTemplateEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an BrandTemplate; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *BrandTemplateEntity) DataTyped(data ...BrandTemplate) BrandTemplate {
	if len(data) > 0 {
		return typedFrom[BrandTemplate](e.Data(asMap(data[0])))
	}
	return typedFrom[BrandTemplate](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through BrandTemplate (all fields
// optional at the wire level).
func (e *BrandTemplateEntity) MatchTyped(match ...BrandTemplate) BrandTemplate {
	if len(match) > 0 {
		return typedFrom[BrandTemplate](e.Match(asMap(match[0])))
	}
	return typedFrom[BrandTemplate](e.Match())
}
...
func (e *BrandTemplateEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *BrandTemplateEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// BrandTemplateLoadMatch and returns an BrandTemplate. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *BrandTemplateEntity) LoadTyped(reqmatch BrandTemplateLoadMatch, ctrl map[string]any) (BrandTemplate, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return BrandTemplate{}, err
	}
	return typedFrom[BrandTemplate](res), nil
}



func (e *BrandTemplateEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *BrandTemplateEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *BrandTemplateEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *BrandTemplateEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *BrandTemplateEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
