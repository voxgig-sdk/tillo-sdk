...
func NewTemplateEntity(client *core.TilloSDK, entopts map[string]any) *TemplateEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *TemplateEntity) Deleted() bool {
	return e.deleted
}
...
func (e *TemplateEntity) List(_ map[string]any, _ map[string]any) (any, error) {
...
func (e *TemplateEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
