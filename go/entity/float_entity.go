...
func NewFloatEntity(client *core.TilloSDK, entopts map[string]any) *FloatEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *FloatEntity) GetName() string { return e.name }
...
func (e *FloatEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *FloatEntity) Deleted() bool {
	return e.deleted
}


func (e *FloatEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewFloatEntity(e.client, opts)
}

func (e *FloatEntity) Data(args ...any) any {
...
func (e *FloatEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Float; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *FloatEntity) DataTyped(data ...Float) Float {
	if len(data) > 0 {
		return typedFrom[Float](e.Data(asMap(data[0])))
	}
	return typedFrom[Float](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Float (all fields
// optional at the wire level).
func (e *FloatEntity) MatchTyped(match ...Float) Float {
	if len(match) > 0 {
		return typedFrom[Float](e.Match(asMap(match[0])))
	}
	return typedFrom[Float](e.Match())
}
...
func (e *FloatEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *FloatEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// FloatListMatch and returns []Float. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *FloatEntity) ListTyped(reqmatch FloatListMatch, ctrl map[string]any) ([]Float, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Float](res), nil
}
...
func (e *FloatEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *FloatEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
