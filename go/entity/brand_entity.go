...
func NewBrandEntity(client *core.TilloSDK, entopts map[string]any) *BrandEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *BrandEntity) GetName() string { return e.name }
...
func (e *BrandEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *BrandEntity) Deleted() bool {
	return e.deleted
}


func (e *BrandEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewBrandEntity(e.client, opts)
}

func (e *BrandEntity) Data(args ...any) any {
...
func (e *BrandEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Brand; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *BrandEntity) DataTyped(data ...Brand) Brand {
	if len(data) > 0 {
		return typedFrom[Brand](e.Data(asMap(data[0])))
	}
	return typedFrom[Brand](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Brand (all fields
// optional at the wire level).
func (e *BrandEntity) MatchTyped(match ...Brand) Brand {
	if len(match) > 0 {
		return typedFrom[Brand](e.Match(asMap(match[0])))
	}
	return typedFrom[Brand](e.Match())
}
...
func (e *BrandEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *BrandEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *BrandEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *BrandEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
