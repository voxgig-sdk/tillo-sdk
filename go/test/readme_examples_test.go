...
const testSeed = `map[string]any{"entity": map[string]any{"brand": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "dgc": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "float": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
