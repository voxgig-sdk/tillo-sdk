...
const testSeed = `map[string]any{"entity": map[string]any{"brand": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "brand_template": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "digital_gift_card": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "digital_issue_delete": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "digital_issue_post": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "digital_order_card": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "digital_order_status": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "digital_top_up_post": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "float": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "physical_gift_card": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "physical_order_card": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "physical_order_status": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "promotion": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "template": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
