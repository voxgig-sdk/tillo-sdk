...
class TilloFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; TilloSDK/1.0)';
    ...
    public static function call(TilloContext $ctx, string $fullurl, array $fetchdef): array
    {
