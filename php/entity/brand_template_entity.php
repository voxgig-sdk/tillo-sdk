...
class BrandTemplateEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new BrandTemplateEntity($this->_client, $opts);
    }

    /**
     * @param BrandTemplate|array $args BrandTemplate data (assoc-array) to store.
     */
    ...
    /**
     * @return BrandTemplate|array The current BrandTemplate data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of BrandTemplate fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of BrandTemplate fields).
     */
    ...
    /**
     * Load a single BrandTemplate.
     *
     * @param BrandTemplateLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed BrandTemplateLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return BrandTemplate|array The loaded BrandTemplate as an assoc-array at the
