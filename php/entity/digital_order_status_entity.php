...
class DigitalOrderStatusEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "digital_order_status";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new DigitalOrderStatusEntity($this->_client, $opts);
    }

    /**
     * @param DigitalOrderStatus|array $args DigitalOrderStatus data (assoc-array) to store.
     */
    ...
    /**
     * @return DigitalOrderStatus|array The current DigitalOrderStatus data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of DigitalOrderStatus fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of DigitalOrderStatus fields).
     */
    ...
    /**
     * Load a single DigitalOrderStatus.
     *
     * @param DigitalOrderStatusLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed DigitalOrderStatusLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DigitalOrderStatus|array The loaded DigitalOrderStatus as an assoc-array at the
