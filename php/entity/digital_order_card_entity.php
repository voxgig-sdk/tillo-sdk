...
class DigitalOrderCardEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new DigitalOrderCardEntity($this->_client, $opts);
    }

    /**
     * @param DigitalOrderCard|array $args DigitalOrderCard data (assoc-array) to store.
     */
    ...
    /**
     * @return DigitalOrderCard|array The current DigitalOrderCard data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of DigitalOrderCard fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of DigitalOrderCard fields).
     */
    ...
    /**
     * Create a new DigitalOrderCard.
     *
     * @param DigitalOrderCardCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed DigitalOrderCardCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DigitalOrderCard|array The created DigitalOrderCard as an assoc-array at the
