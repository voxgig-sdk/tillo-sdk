...
// Tillo SDK DigitalGiftCard entity
...
class DigitalGiftCardEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new DigitalGiftCardEntity($this->_client, $opts);
    }

    /**
     * @param DigitalGiftCard|array $args DigitalGiftCard data (assoc-array) to store.
     */
    ...
    /**
     * @return DigitalGiftCard|array The current DigitalGiftCard data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of DigitalGiftCard fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of DigitalGiftCard fields).
     */
    ...
    /**
     * Load a single DigitalGiftCard.
     *
     * @param DigitalGiftCardLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed DigitalGiftCardLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DigitalGiftCard|array The loaded DigitalGiftCard as an assoc-array at the
    ...
    /**
     * Create a new DigitalGiftCard.
     *
     * @param DigitalGiftCardCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed DigitalGiftCardCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DigitalGiftCard|array The created DigitalGiftCard as an assoc-array at the
     *   SDK boundary; throws TilloError on failure (item-5 convention).
     */
