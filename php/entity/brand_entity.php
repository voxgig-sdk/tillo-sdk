...
class BrandEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new BrandEntity($this->_client, $opts);
    }

    /**
     * @param Brand|array $args Brand data (assoc-array) to store.
     */
    ...
    /**
     * @return Brand|array The current Brand data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Brand fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Brand fields).
     */
