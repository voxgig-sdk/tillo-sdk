...
class DgcEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new DgcEntity($this->_client, $opts);
    }

    /**
     * @param Dgc|array $args Dgc data (assoc-array) to store.
     */
    ...
    /**
     * @return Dgc|array The current Dgc data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Dgc fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Dgc fields).
     */
     ...
     * Create a new Dgc.
     *
     * @param DgcCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed DgcCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Dgc|array The created Dgc as an assoc-array at the
