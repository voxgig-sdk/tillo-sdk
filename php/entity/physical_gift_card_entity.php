...
// Tillo SDK PhysicalGiftCard entity
...
class PhysicalGiftCardEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new PhysicalGiftCardEntity($this->_client, $opts);
    }

    /**
     * @param PhysicalGiftCard|array $args PhysicalGiftCard data (assoc-array) to store.
     */
    ...
    /**
     * @return PhysicalGiftCard|array The current PhysicalGiftCard data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of PhysicalGiftCard fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of PhysicalGiftCard fields).
     */
    ...
    /**
     * Create a new PhysicalGiftCard.
     *
     * @param PhysicalGiftCardCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed PhysicalGiftCardCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PhysicalGiftCard|array The created PhysicalGiftCard as an assoc-array at the
    ...
    /**
     * Remove an PhysicalGiftCard matching the given criteria.
     *
     * @param PhysicalGiftCardRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; PhysicalGiftCardRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PhysicalGiftCard|array The removed PhysicalGiftCard as an assoc-array at the
     *   SDK boundary; throws TilloError on failure (item-5 convention).
     */
