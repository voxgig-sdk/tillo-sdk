...
class PhysicalOrderCardEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "physical_order_card";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new PhysicalOrderCardEntity($this->_client, $opts);
    }

    /**
     * @param PhysicalOrderCard|array $args PhysicalOrderCard data (assoc-array) to store.
     */
    ...
    /**
     * @return PhysicalOrderCard|array The current PhysicalOrderCard data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of PhysicalOrderCard fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of PhysicalOrderCard fields).
     */
    ...
    /**
     * Create a new PhysicalOrderCard.
     *
     * @param PhysicalOrderCardCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed PhysicalOrderCardCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PhysicalOrderCard|array The created PhysicalOrderCard as an assoc-array at the
