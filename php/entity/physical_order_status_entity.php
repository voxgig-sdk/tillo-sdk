...
class PhysicalOrderStatusEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "physical_order_status";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new PhysicalOrderStatusEntity($this->_client, $opts);
    }

    /**
     * @param PhysicalOrderStatus|array $args PhysicalOrderStatus data (assoc-array) to store.
     */
    ...
    /**
     * @return PhysicalOrderStatus|array The current PhysicalOrderStatus data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of PhysicalOrderStatus fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of PhysicalOrderStatus fields).
     */
    ...
    /**
     * Create a new PhysicalOrderStatus.
     *
     * @param PhysicalOrderStatusCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed PhysicalOrderStatusCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PhysicalOrderStatus|array The created PhysicalOrderStatus as an assoc-array at the
