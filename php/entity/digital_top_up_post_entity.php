...
class DigitalTopUpPostEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "digital_top_up_post";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new DigitalTopUpPostEntity($this->_client, $opts);
    }

    /**
     * @param DigitalTopUpPost|array $args DigitalTopUpPost data (assoc-array) to store.
     */
    ...
    /**
     * @return DigitalTopUpPost|array The current DigitalTopUpPost data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of DigitalTopUpPost fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of DigitalTopUpPost fields).
     */
    ...
    /**
     * Create a new DigitalTopUpPost.
     *
     * @param DigitalTopUpPostCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed DigitalTopUpPostCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DigitalTopUpPost|array The created DigitalTopUpPost as an assoc-array at the
