...
// Tillo SDK DigitalIssueDelete entity
...
class DigitalIssueDeleteEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "digital_issue_delete";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new DigitalIssueDeleteEntity($this->_client, $opts);
    }

    /**
     * @param DigitalIssueDelete|array $args DigitalIssueDelete data (assoc-array) to store.
     */
    public function data_set($args): void
    {
        if ($args) {
            $this->_data = TilloHelpers::to_map(Struct::clone($args)) ?? [];
            ($this->_utility->feature_hook)($this->_entctx, "SetData");
        }
    }

    /**
     * @return DigitalIssueDelete|array The current DigitalIssueDelete data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of DigitalIssueDelete fields).
     */
    public function match_set($args): void
    {
        if ($args) {
            $this->_match = TilloHelpers::to_map(Struct::clone($args)) ?? [];
            ($this->_utility->feature_hook)($this->_entctx, "SetMatch");
        }
    }

    /**
     * @return array The current match filter (any subset of DigitalIssueDelete fields).
     */
    ...
    /**
     * Create a new DigitalIssueDelete.
     *
     * @param DigitalIssueDeleteCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed DigitalIssueDeleteCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DigitalIssueDelete|array The created DigitalIssueDelete as an assoc-array at the
    ...
    /**
     * Remove an DigitalIssueDelete matching the given criteria.
     *
     * @param DigitalIssueDeleteRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; DigitalIssueDeleteRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DigitalIssueDelete|array The removed DigitalIssueDelete as an assoc-array at the
     *   SDK boundary; throws TilloError on failure (item-5 convention).
     */
