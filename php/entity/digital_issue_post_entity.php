...
class DigitalIssuePostEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new DigitalIssuePostEntity($this->_client, $opts);
    }

    /**
     * @param DigitalIssuePost|array $args DigitalIssuePost data (assoc-array) to store.
     */
    ...
    /**
     * @return DigitalIssuePost|array The current DigitalIssuePost data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of DigitalIssuePost fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of DigitalIssuePost fields).
     */
    ...
    /**
     * Create a new DigitalIssuePost.
     *
     * @param DigitalIssuePostCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed DigitalIssuePostCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DigitalIssuePost|array The created DigitalIssuePost as an assoc-array at the
