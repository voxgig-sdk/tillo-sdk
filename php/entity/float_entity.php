...
class FloatEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new FloatEntity($this->_client, $opts);
    }

    /**
     * @param Float|array $args Float data (assoc-array) to store.
     */
    ...
    /**
     * @return Float|array The current Float data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Float fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Float fields).
     */
    ...
    /**
     * List Float items matching the given filter.
     *
     * @param FloatListMatch|array|null $reqmatch Match filter (any subset
     *   of Float fields) as an assoc-array; FloatListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Float[]|array A list of Float items as assoc-arrays at
