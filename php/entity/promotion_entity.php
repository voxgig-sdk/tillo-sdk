...
class PromotionEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new PromotionEntity($this->_client, $opts);
    }

    /**
     * @param Promotion|array $args Promotion data (assoc-array) to store.
     */
    ...
    /**
     * @return Promotion|array The current Promotion data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Promotion fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Promotion fields).
     */
    ...
    /**
     * Load a single Promotion.
     *
     * @param PromotionLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed PromotionLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Promotion|array The loaded Promotion as an assoc-array at the
