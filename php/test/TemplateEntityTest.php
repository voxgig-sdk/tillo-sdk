...
class TemplateEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set TILLO_TEST_TEMPLATE_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function template_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("TILLO_TEST_TEMPLATE_ENTID");
