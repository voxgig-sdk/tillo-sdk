...
// Tillo SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (TilloSDK::test)
...
{
    private const SDK_CLASS = 'TilloSDK';
    ...
    private const SDK_BASE = 'tillo_sdk';
