...
class TilloTestRunner
{
    ...
    {
        $live = self::getenv('TILLO_TEST_LIVE');
        $override = self::getenv('TILLO_TEST_OVERRIDE');
        ...
        $explain = self::getenv('TILLO_TEST_EXPLAIN');
...
class_alias('TilloTestRunner', 'Runner');
class_alias('TilloHelpers', 'Helpers');
