...
// Tillo SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class TilloTestFeature extends TilloBaseFeature
{
    ...
    public function init(TilloContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (TilloContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (TilloContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(TilloContext $ctx, $op, $args): array
    {
