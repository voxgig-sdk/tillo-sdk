...
class TilloPagingFeature extends TilloBaseFeature
{
    ...
    private function _graphql_pre_request(TilloContext $ctx, array $paging): void
    {
        $body = $ctx->spec->body;
        if (!is_array($body)) {
            return;
    ...
    private function _is_list(TilloContext $ctx): bool
    {
