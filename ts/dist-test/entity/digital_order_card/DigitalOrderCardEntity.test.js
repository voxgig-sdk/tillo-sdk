...
(0, node_test_1.describe)('DigitalOrderCardEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create']) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'digital_order_card.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != digital_order_card_ref01_data);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/digital_order_card/DigitalOrderCardTestData.json');
    ...
    let idmap = transform(['digital_order_card01', 'digital_order_card02', 'digital_order_card03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=DigitalOrderCardEntity.test.js.map