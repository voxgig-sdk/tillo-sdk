...
(0, node_test_1.describe)('PromotionDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-promotion', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-promotion', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['TILLO_TEST_PROMOTION_ENTID'];
...
//# sourceMappingURL=PromotionDirect.test.js.map