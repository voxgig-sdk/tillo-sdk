...
(0, node_test_1.describe)('BrandTemplateDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-brand_template', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-brand_template', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['TILLO_TEST_BRAND_TEMPLATE_ENTID'];
...
//# sourceMappingURL=BrandTemplateDirect.test.js.map