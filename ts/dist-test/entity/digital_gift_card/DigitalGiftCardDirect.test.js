...
(0, node_test_1.describe)('DigitalGiftCardDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-digital_gift_card', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-digital_gift_card', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['TILLO_TEST_DIGITAL_GIFT_CARD_ENTID'];
...
//# sourceMappingURL=DigitalGiftCardDirect.test.js.map