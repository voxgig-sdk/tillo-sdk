...
(0, node_test_1.describe)('DigitalOrderStatusDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-digital_order_status', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-digital_order_status', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.TILLO_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.TilloSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
            apikey: env.TILLO_APIKEY,
        }));
        let idmap = env['TILLO_TEST_DIGITAL_ORDER_STATUS_ENTID'];
...
//# sourceMappingURL=DigitalOrderStatusDirect.test.js.map