...
(0, node_test_1.describe)('FloatDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-float', async (t) => {
        ...
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-float', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['TILLO_TEST_FLOAT_ENTID'];
...
//# sourceMappingURL=FloatDirect.test.js.map