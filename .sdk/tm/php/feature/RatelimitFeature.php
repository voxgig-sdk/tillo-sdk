...
class TilloRatelimitFeature extends TilloBaseFeature
{
    ...
    private function _acquire(TilloContext $ctx): void
    {
    ...
    private function _track(TilloContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
