...
class TilloTimeoutFeature extends TilloBaseFeature
{
    ...
    private function _with_timeout(TilloContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(TilloContext $_ctx, float $ms): void
    {
        $client = $this->client;
