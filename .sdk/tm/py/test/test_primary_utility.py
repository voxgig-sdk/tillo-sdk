...
from projectname_sdk import TilloSDK
from projectname_sdk.core.spec import TilloSpec
from projectname_sdk.core.result import TilloResult
from projectname_sdk.core.response import TilloResponse
from projectname_sdk.core.operation import TilloOperation
from projectname_sdk.core.error import TilloError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import TilloBaseFeature
...
class TestPrimaryUtility:
    ...
    def test_exists(self):
        client = TilloSDK.test(None, None)
    ...
    def test_feature_init_basic(self):
        init_client = TilloSDK.test(None, None)
        ...
        class TestInitFeature(TilloBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(TilloBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = TilloSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = TilloSDK.test(None, setup_opts)
