...
class TilloTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = TilloTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = TilloTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = TilloTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
