...
from projectname_sdk.core.control import TilloControl
...
class TilloContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, TilloResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return TilloError(code, msg, self)
