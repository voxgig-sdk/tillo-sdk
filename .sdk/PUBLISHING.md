...
|---|---|---|
| `js/` | @voxgig-sdk/tillo-js | `.github/workflows/publish-js.yml` |
| `ts/` | @voxgig-sdk/tillo | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/tillo-js \
      --repository voxgig-sdk/tillo-sdk \
      --file publish-js.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/tillo-js` shows it, and
`npm trust revoke @voxgig-sdk/tillo-js --id=<id>` removes it.
